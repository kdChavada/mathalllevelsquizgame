...
class Quiz13View extends StatefulWidget {
  int colorData;
  String levelName;

  Quiz13View({Key? key, required this.colorData, required this.levelName})
      : super(key: key);

  @override
  State<Quiz13View> createState() => _Quiz13ViewState();
}

class _Quiz13ViewState extends State<Quiz13View> {
  Quiz13Bloc quiz01bloc = Quiz13Bloc();
