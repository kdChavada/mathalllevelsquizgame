...
class Quiz12View extends StatefulWidget {
  int colorData;
  String levelName;

  Quiz12View({Key? key, required this.colorData, required this.levelName})
      : super(key: key);

  @override
  State<Quiz12View> createState() => _Quiz12ViewState();
}

class _Quiz12ViewState extends State<Quiz12View> {
  Quiz12Bloc quiz01bloc = Quiz12Bloc();
