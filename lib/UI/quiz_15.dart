...
class Quiz15View extends StatefulWidget {
  int colorData;
  String levelName;
  Quiz15View({Key? key,required  this.colorData,required  this.levelName}) : super(key: key);

  @override
  State<Quiz15View> createState() => _Quiz15ViewState();
}

class _Quiz15ViewState extends State<Quiz15View> {

  Quiz15Bloc quiz01bloc = Quiz15Bloc();
