...
class Quiz010View extends StatefulWidget {
  int colorData;
  String levelName;

  Quiz010View({Key? key, required this.colorData, required this.levelName})
      : super(key: key);

  @override
  State<Quiz010View> createState() => _Quiz010ViewState();
}

class _Quiz010ViewState extends State<Quiz010View> {
  Quiz10Bloc quiz01bloc = Quiz10Bloc();
