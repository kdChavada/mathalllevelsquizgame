...
class Quiz03View extends StatefulWidget {
  int colorData;
  String levelName;
   Quiz03View({Key? key,required  this.colorData,required  this.levelName}) : super(key: key);

  @override
  State<Quiz03View> createState() => _Quiz03ViewState();
}

class _Quiz03ViewState extends State<Quiz03View> {

  Quiz03Bloc quiz01bloc = Quiz03Bloc();
