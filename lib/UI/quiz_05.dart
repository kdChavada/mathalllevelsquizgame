...
class Quiz05View extends StatefulWidget {
  int colorData;
  String levelName;
  Quiz05View({Key? key,required  this.colorData,required  this.levelName}) : super(key: key);

  @override
  State<Quiz05View> createState() => _Quiz05ViewState();
}

class _Quiz05ViewState extends State<Quiz05View> {

  Quiz05Bloc quiz01bloc = Quiz05Bloc();
