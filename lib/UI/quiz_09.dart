...
class Quiz09View extends StatefulWidget {
  int colorData;
  String levelName;

  Quiz09View({Key? key, required this.colorData, required this.levelName})
      : super(key: key);

  @override
  State<Quiz09View> createState() => _Quiz09ViewState();
}

class _Quiz09ViewState extends State<Quiz09View> {
  Quiz09Bloc quiz01bloc = Quiz09Bloc();
