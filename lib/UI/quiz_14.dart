...
class Quiz14View extends StatefulWidget {
  int colorData;
  String levelName;

  Quiz14View({Key? key, required this.colorData, required this.levelName})
      : super(key: key);

  @override
  State<Quiz14View> createState() => _Quiz14ViewState();
}

class _Quiz14ViewState extends State<Quiz14View> {
  Quiz14Bloc quiz01bloc = Quiz14Bloc();
