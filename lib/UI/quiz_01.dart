...
class Quiz01View extends StatefulWidget {
  int colorData;
  String levelName;

  Quiz01View({Key? key, required this.colorData, required this.levelName})
      : super(key: key);

  @override
  State<Quiz01View> createState() => _Quiz01ViewState();
}

class _Quiz01ViewState extends State<Quiz01View> {
  Quiz01Bloc quiz01bloc = Quiz01Bloc();
