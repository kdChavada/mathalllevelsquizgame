...
class Quiz06View extends StatefulWidget {
  int colorData;
  String levelName;
  Quiz06View({Key? key,required  this.colorData,required  this.levelName}) : super(key: key);

  @override
  State<Quiz06View> createState() => _Quiz06ViewState();
}

class _Quiz06ViewState extends State<Quiz06View> {

  Quiz06Bloc quiz01bloc = Quiz06Bloc();
