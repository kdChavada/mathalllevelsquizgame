...
class Quiz07View extends StatefulWidget {
  int colorData;
  String levelName;

  Quiz07View({Key? key, required this.colorData, required this.levelName})
      : super(key: key);

  @override
  State<Quiz07View> createState() => _Quiz07ViewState();
}

class _Quiz07ViewState extends State<Quiz07View> {
  Quiz07Bloc quiz01bloc = Quiz07Bloc();
