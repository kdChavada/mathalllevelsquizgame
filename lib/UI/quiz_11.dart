...
class Quiz11View extends StatefulWidget {
  int colorData;
  String levelName;

  Quiz11View({Key? key, required this.colorData, required this.levelName})
      : super(key: key);

  @override
  State<Quiz11View> createState() => _Quiz11ViewState();
}

class _Quiz11ViewState extends State<Quiz11View> {
  Quiz11Bloc quiz01bloc = Quiz11Bloc();
