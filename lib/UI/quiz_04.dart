...
class Quiz04View extends StatefulWidget {
  int colorData;
  String levelName;
  Quiz04View({Key? key,required  this.colorData,required  this.levelName}) : super(key: key);

  @override
  State<Quiz04View> createState() => _Quiz04ViewState();
}

class _Quiz04ViewState extends State<Quiz04View> {

  Quiz04Bloc quiz01bloc = Quiz04Bloc();
